...
public class Resultado extends javax.swing.JFrame {
     ...
     */
	  ...
	  public Resultado(CentralBotão TelaSuperior,VotoDAO vDAO,CandidatoDAO cDAO) {
		 this.TelaSuperior=TelaSuperior;
		 this.vDAO=vDAO;
		 this.cDAO=cDAO;
		 this.nVotos=new int[cDAO.Total];//Mesmo numero de Candidatos
	     initComponents();
	     String resultado="";
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(LabelResultado, javax.swing.GroupLayout.DEFAULT_SIZE, 376, Short.MAX_VALUE)
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(LabelResultado, javax.swing.GroupLayout.DEFAULT_SIZE, 276, Short.MAX_VALUE)
                .addContainerGap())
        );
